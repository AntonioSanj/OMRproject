...
# testNoteHeadDetectionFolder(myFiguresDataSet + '/double', 'double', num)
testNoteHeadDetectionRandomPicks(myFiguresDataSet + '/half', 'half', num_images=40)
testNoteHeadDetectionRandomPicks(myFiguresDataSet + '/one', 'one', False, 40)
testNoteHeadDetectionRandomPicks(myFiguresDataSet + '/double', 'double', False, 40)
testNoteHeadDetectionRandomPicks(myFiguresDataSet + '/quarter', 'quarter', False, 40)
testGetFourHeadCentersRandomPick(myFiguresDataSet + '/four', 40, debug=False)
